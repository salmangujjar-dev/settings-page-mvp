      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-col gap-y-2">
          {APP_INTEGRATIONS.map((item) => (
            <div
              key={`app-${item.label}`}
              className="flex items-center bg-white rounded-lg p-2 border border-gray-300 cursor-pointer hover:border-gray-400"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          {NEXT_APP_INTEGRATIONS.map((item) => (
            <div
              ...
              className="flex flex-col justify-between gap-y-2 bg-white rounded-lg p-3 border border-gray-300"
            >
              ...
              <button className="bg-[#E7E7E7] rounded-md text-xs py-1 font-semibold hover:bg-[#DDDDDD]">
                Request
              </button>
            </div>
          ))}
        ...
        <hr className="my-6 bg-gray-200 h-0.5" />
        <div className="flex items-center p-2 py-3 bg-[#E7E7E7] rounded-md">
          ...
          />
          <button className="ms-2 bg-[#C5C5C5] font-semibold text-xs px-2 py-1.5 rounded-md">
            Send
          </button>
        </div>
      </div>
